...
const LoginForm = () => {
  ...
  const onLogin = async () => {
    ...
    const userRes = await axios__WEBPACK_IMPORTED_MODULE_2___default()({
      method: "POST",
      data: user,
      url: `${_library_globalVariables__WEBPACK_IMPORTED_MODULE_7__["default"].serverURL}/users/authenticate-user`,
      responseType: "json"
    });
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_10__["Typography"], {
    component: "h2",
    variant: "h4",
    gutterBottom: true,
    __source: {
    ...
    __self: undefined
  }, new _library_stringMethods__WEBPACK_IMPORTED_MODULE_9__["default"](_library_languages__WEBPACK_IMPORTED_MODULE_8__["default"].en.login).firstCharUpperCase().getString()), __jsx("form", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 45
    },
    ...
    __self: undefined
  }, logging ? __jsx(_LoadingSpinner__WEBPACK_IMPORTED_MODULE_6__["default"], {
    margin: "r",
    level: 1,
    __source: {
      fileName: _jsxFileName,
    ...
    __self: undefined
  }) : null, __jsx(_Button__WEBPACK_IMPORTED_MODULE_5__["default"], {
    onClick: onLogin,
    text: _library_languages__WEBPACK_IMPORTED_MODULE_8__["default"].en.login,
    variant: "contained",
    disabled: logging,
    __source: {
      fileName: _jsxFileName,
...
const RegisterForm = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_9__["Typography"], {
    ...
    __self: undefined
  }, isReg ? __jsx(_LoadingSpinner__WEBPACK_IMPORTED_MODULE_8__["default"], {
    margin: "r",
    level: 1,
    __source: {
      fileName: _jsxFileName,
    ...
    __self: undefined
  }) : null, __jsx(_Button__WEBPACK_IMPORTED_MODULE_4__["default"], {
    onClick: onRegister,
