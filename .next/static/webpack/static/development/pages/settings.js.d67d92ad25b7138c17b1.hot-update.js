...
var WebFormList = function WebFormList(_ref) {
  ...
  var list = webFields.map(function (_ref2) {
    ...
    return fieldInForm ? __jsx("li", {
      ...
      __self: this
    }, fieldName, " ", fieldFormVisible ? "-> visible in form" : "-> Not visible with ".concat(fieldOptions ? fieldOptions.filter(function (option) {
      return option.preselected;
    }) : null, " preselected"), __jsx("button", {
      id: fieldName,
...
//# sourceMappingURL=settings.js.d67d92ad25b7138c17b1.hot-update.js.map