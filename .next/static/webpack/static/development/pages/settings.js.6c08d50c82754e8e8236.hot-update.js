...
var WebFormSelect = function WebFormSelect(_ref) {
  ...
  var selects = webFields.map(function (field) {
    return field.fieldInForm ? __jsx("select", {
      name: "fields",
      ...
      __self: this
    }, _library_globalVariables__WEBPACK_IMPORTED_MODULE_1__["default"].blankOption), selectOptions) : null;
  });
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, selects, __jsx("select", {
    name: "fields",
    onChange: addedToForm,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=settings.js.6c08d50c82754e8e8236.hot-update.js.map