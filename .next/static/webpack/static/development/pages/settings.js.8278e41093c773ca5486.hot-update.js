...
var WebForm = function WebForm(_ref) {
  ...
  var _useReducer = Object(react__WEBPACK_IMPORTED_MODULE_1__["useReducer"])(function (state, action) {
    switch (action.type) {
      ...
      case "remove":
        return state.map(function (field) {
          return field.fieldName === action.payload.fieldName ? field.fieldType !== "select" ? Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, field, {
            fieldInForm: false
          }) : Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, field, {
            fieldFormVisible: false,
            fieldOptions: field.fieldOpions.map(function (option) {
...
//# sourceMappingURL=settings.js.8278e41093c773ca5486.hot-update.js.map