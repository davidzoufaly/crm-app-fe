          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              clients.map(function (client) {
                return client.isChecked ? clientsToDelete.push("ObjectId(".concat(client._id, ")")) : null;
              });
              console.log(clientsToDelete); // const resDelete = await axios({
              //   method: "delete",
              //   data: clientsToDelete,
              //   url: `${globalVars.serverURL}/clients`,
              //   responseType: "json"
              // })
              // const dataDelete = await resDelete;
              // dataDelete
...
//# sourceMappingURL=clients.js.837bd1dd312b3eab70f2.hot-update.js.map