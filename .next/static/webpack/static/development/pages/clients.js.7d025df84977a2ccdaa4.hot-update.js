...
var CreateClient = function CreateClient(_ref) {
  ...
  var initialNewClientState = function initialNewClientState(fields) {
    var clientObj = fields.map(function (e) {
      return e.fieldName;
    ...
    clientObj._id = generate_unique_id__WEBPACK_IMPORTED_MODULE_12___default()({
      length: 24,
      useNumbers: true,
      useLetters: false,
      includeSymbols: ["a", "b", "c", "d", "e", "f"]
    }), clientObj.dateAdded = moment__WEBPACK_IMPORTED_MODULE_13___default()().format("llll");
    return clientObj;
  };
...
//# sourceMappingURL=clients.js.7d025df84977a2ccdaa4.hot-update.js.map