...
var stringMethods = function stringMethods(_text) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "splitStringByIndex", function () {
    ...
    for (var _i = 0; _i <= _this.helperArray.length; _i++) {
      if (_i === 0) {
        //first iteration
        arrayText.push(_this.text.substr(0, _this.helperArray[_i]));
      } else if (_i > 0 && _i < _this.helperArray.length) {
        //iteration in the middle
        arrayText.push(_this.text.substr(_this.helperArray[_i - 1], _this.helperArray[_i] - _this.helperArray[_i - 1]));
      } else if (_i === _this.helperArray.length) {
        //last iteration
        arrayText.push(_this.text.substr(_this.helperArray[_i - 1]));
      }
    }
...
//# sourceMappingURL=clients.js.026f79573baffb85b84f.hot-update.js.map