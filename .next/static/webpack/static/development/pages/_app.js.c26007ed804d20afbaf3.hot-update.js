...
function (_App) {
  ...
  function MyApp() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_10__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8__["default"])(_this), "setUser", function (username) {
      _this.setState(Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, _this.state, _this.state.user, {
        username: username
      }));

      sessionStorage.setItem('user', _this.state.user.username);
      sessionStorage.setItem('signedIn', _this.state.user.signedIn);
...
//# sourceMappingURL=_app.js.c26007ed804d20afbaf3.hot-update.js.map