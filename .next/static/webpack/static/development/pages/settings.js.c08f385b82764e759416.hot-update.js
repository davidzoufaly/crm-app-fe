...
var WebForm = function WebForm(_ref) {
  ...
  var addedToForm = function addedToForm(e) {
    webFields.map(function (field) {
      return field.fieldType !== "select" ? field.fieldName === e.target.value ? setWebFields({
        type: "add",
        payload: {
          fieldName: e.target.value
        }
      }) : null : setOptionSelect(e.target.value);
    });
  };
...
//# sourceMappingURL=settings.js.c08f385b82764e759416.hot-update.js.map