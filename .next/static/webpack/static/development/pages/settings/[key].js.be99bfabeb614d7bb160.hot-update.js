...
var addField = function addField(obj, dispatch) {
  dispatch({
    type: "addNewField",
    payload: {
      obj: obj
...
var deleteField = function deleteField(id, dispatch) {
  dispatch({
    type: "deleteField",
    payload: {
      id: id
...
//# sourceMappingURL=[key].js.be99bfabeb614d7bb160.hot-update.js.map