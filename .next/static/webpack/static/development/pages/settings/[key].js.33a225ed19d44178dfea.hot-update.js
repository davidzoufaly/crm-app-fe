      ...
      case "optionDelete":
        return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state, {
          fieldOptions: state.fieldOptions.map(function (e) {
            return action.payload.id === e.id && e.preselected ? state.fieldInForm === false : null;
          }).filter(action.payload.id !== e.id)
        });
...
//# sourceMappingURL=[key].js.33a225ed19d44178dfea.hot-update.js.map