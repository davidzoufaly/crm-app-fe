  ...
  var _useReducer = Object(react__WEBPACK_IMPORTED_MODULE_4__["useReducer"])(function (state, action) {
    switch (action.type) {
      ...
      case "optionDelete":
        console.log(state);
        return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state, {
          fieldOptions: state.fieldOptions.map(function (e) {
            return action.payload.id === e.id && e.preselected ? Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state, {
              fieldInForm: false
            }) : {
              state: state
            };
...
//# sourceMappingURL=[key].js.ff8068323566970cd655.hot-update.js.map