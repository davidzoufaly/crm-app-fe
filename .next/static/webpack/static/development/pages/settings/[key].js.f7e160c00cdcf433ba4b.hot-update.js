...
var handleAddingToWF = function handleAddingToWF(dispatch, state, counter, setCounter, e) {
  console.log(e.target.target.getAttribute('data-value'));
  state.map(function (field) {
    if (field.fieldName === e.target.dataValue) {
      // console.log();
...
//# sourceMappingURL=[key].js.f7e160c00cdcf433ba4b.hot-update.js.map