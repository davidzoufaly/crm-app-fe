...
var WebFormSubSelect = function WebFormSubSelect(_ref) {
  ...
  return state.some(function (e) {
    ...
    __self: this
  }, _library_languages__WEBPACK_IMPORTED_MODULE_1__["default"].en.pleaseSelectOption, " ", e.fieldName), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_2__["Box"], {
    width: "50%",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17
    ...
    onChange: function onChange() {
      return addHiddenSelect(dispatch, setCounter, counter, event);
    },
    value: "",
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=[key].js.4953be80b8818c236f4d.hot-update.js.map