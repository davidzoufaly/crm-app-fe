...
var CustomFields = function CustomFields(_ref) {
  ...
  var _useReducer = Object(react__WEBPACK_IMPORTED_MODULE_4__["useReducer"])(function (state, action) {
    switch (action.type) {
      ...
      case "optionDelete":
        return state.fieldInForm && state.fieldOptions.some(function (e) {
          return e.id === action.payload.id && epreselected;
...
//# sourceMappingURL=[key].js.231200b153348ebf460f.hot-update.js.map