...
var removeFromList = function removeFromList(_, event) {
  console.log(event.currentTarget); // console.log(e.currentTarget);
  // dispatch({
  //   type: "removeFromWF",
  //   payload: { fieldName: e}
  // });
...
//# sourceMappingURL=[key].js.c602bbf4f0cc9be459b2.hot-update.js.map