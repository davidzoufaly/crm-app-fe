...
var WebFormList = function WebFormList(_ref) {
  ...
  var list = webFields.map(function (_ref2) {
    ...
    return fieldInForm ? __jsx("li", {
      ...
      __self: this
    }, fieldName, " ", fieldFormVisible ? "-> visible in form" : "-> Not visible with ".concat(fieldOptions.filter(function (option) {
      return option.preselected ? option.preselected : null;
    }), " preselected"), __jsx("button", {
      id: fieldName,
...
//# sourceMappingURL=settings.js.e2dea72005f8fead77bf.hot-update.js.map