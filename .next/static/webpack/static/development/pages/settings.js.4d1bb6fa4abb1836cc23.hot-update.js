...
var WebFormOptions = function WebFormOptions(_ref) {
  ...
  var options = optionSelect[0].fieldOptions.forEach(function (option) {
    return __jsx("option", {
      key: option.id,
      value: option.value,
      __source: {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, options);
};
...
//# sourceMappingURL=settings.js.4d1bb6fa4abb1836cc23.hot-update.js.map