...
var Clients = function Clients(_ref) {
    ...
    switch (action.type) {
      case "handleCheckedClients":
        return state.map(function (client) {
          return client._id === action.payload.id ? client.isChecked === false || client.isChecked === undefined ? client : client : client;
        });
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])("firstName"),
      sort = _useState2[0],
...
//# sourceMappingURL=clients.js.1b528a016f6efe96fd82.hot-update.js.map