...
var ClientsList = function ClientsList(_ref) {
  ...
  var sortPodle = clients.sort(function (a, b) {
    return b > a ? -1 : 1;
  }); // const reverse = reverse ? clients.reverse() : clients.reverse();

  var tableClients = sortPodle.map(function (e) {
    return __jsx("tr", {
      key: e._id,
      __source: {
...
//# sourceMappingURL=clients.js.b97fc35f62c9845a011b.hot-update.js.map