...
var Clients = function Clients(_ref) {
  ...
  var handleCheckbox = function handleCheckbox(id) {
    setClients(clients.map(function (client) {
      return client._id === id && (client.isChecked === false || client.isChecked === undefined) ? Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, client, {
        isChecked: true
      }) : client;
    }));
  };
...
//# sourceMappingURL=clients.js.095f9013a4fba026d277.hot-update.js.map