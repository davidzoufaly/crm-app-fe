...
/* harmony import */ var _ClientForm__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ClientForm */ "./components/clients/ClientForm.tsx");
...
/* harmony import */ var generate_unique_id__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! generate-unique-id */ "./node_modules/generate-unique-id/index.js");
...
var CreateClient = function CreateClient(_ref) {
  ...
  var initialNewClintState = fields.map(function (e) {
    ...
    return _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_3___default()(o, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])({}, key, ""));
  }, {});

  var _useReducer = Object(react__WEBPACK_IMPORTED_MODULE_4__["useReducer"])(function (state, action) {
    switch (action.type) {
      case "onTextChange":
        return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, state, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])({}, action.payload.fieldName, action.payload.fieldType === "number" ? _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_0___default()(action.payload.value) : action.payload.value));
      ...
      case "addDate":
        return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, state, {
          dateAdded: moment__WEBPACK_IMPORTED_MODULE_11___default()().format("llll")
        });
  ...
  var onSubmit = function onSubmit(e) {
    ...
    var clientRes = axios__WEBPACK_IMPORTED_MODULE_8___default()({
      method: "post",
      data: newClient,
  ...
  return isClientAdded ? __jsx("div", {
    ...
    __self: this
  }, __jsx(_ClientForm__WEBPACK_IMPORTED_MODULE_7__["default"], {
    fields: fields,
    onChange: onChange,
    newClient: newClient,
    __source: {
    ...
    __self: this
  }, "Save"), __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_5__["default"], {
    variant: "contained",
    color: "secondary",
    onClick: onCancel,
    __source: {
...
//# sourceMappingURL=clients.js.582e288222e5156de867.hot-update.js.map