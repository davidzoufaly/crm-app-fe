...
var Clients = function Clients(_ref) {
  ...
  var handleCheckbox = function handleCheckbox(id) {
    setClients(clients.map(function (e) {
      return e._id === id && (e.isChecked === false || e.isChecked === undefined) ? Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, clients, {
        isChecked: true
      }) : Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, clients, {
        isChecked: false
      });
    }));
  };
  ...
  return __jsx("div", {
    ...
    __self: this
  }, h1), __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_12__["default"], {
    variant: "contained",
    color: "primary",
    ...
    __self: this
  }, "Add new client"), __jsx(_components_CreateClient__WEBPACK_IMPORTED_MODULE_11__["default"], {
    fields: fieldData,
...
//# sourceMappingURL=clients.js.fb2e09e2fe23d6a0c026.hot-update.js.map