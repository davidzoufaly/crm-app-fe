...
var WebFormList = function WebFormList(_ref) {
  ...
  var list = webFields.map(function (_ref2) {
    ...
    return fieldInForm ? __jsx("li", {
      ...
      __self: this
    }, fieldName, fieldFormVisible ? "-> visible in form" : fieldType === "select" // ? fieldOptions.some(e => e.preselected)
    ? "-> hidden in form with ".concat(fieldOptions.map(function (e) {
...
//# sourceMappingURL=settings.js.a5514fc0569ba8b005fe.hot-update.js.map