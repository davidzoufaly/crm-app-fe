  ...
  var tableClients = clients.map(function (client) {
    ...
    var tableItem = function tableItem() {
      ...
      items.push(__jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_4__["default"], {
        ...
        as: "/q/".concat(questionId, "/").concat(subject),
        href: "/question?id=".concat(questionId, "&subject=").concat(subject),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 74
        },
        ...
        __self: this
      }, question)), __jsx(next_link__WEBPACK_IMPORTED_MODULE_1___default.a, {
        href: "/clients/client/[id]?key=96DEY3UZP9AIBT0ENNT68A1Q0RAT4TUN",
...
//# sourceMappingURL=[key].js.a8af255bc2d17b506042.hot-update.js.map