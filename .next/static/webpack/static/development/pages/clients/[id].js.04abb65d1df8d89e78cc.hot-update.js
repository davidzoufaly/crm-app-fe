...
_babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
  var router, _useState, _useState2, id, setId, res, data;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _useState = useState(), _useState2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_useState, 2), id = _useState2[0], setId = _useState2[1];
          setId(router.query.id);
          _context.next = 5;
          return axios__WEBPACK_IMPORTED_MODULE_6___default()({
            method: "get",
            url: "http://localhost:8080/".concat(id),
            responseType: "json"
          });
...
//# sourceMappingURL=[id].js.04abb65d1df8d89e78cc.hot-update.js.map