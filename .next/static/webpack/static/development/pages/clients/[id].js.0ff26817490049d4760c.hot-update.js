...
var varToString = function varToString(text) {
  var textArray = _babel_runtime_corejs2_core_js_array_from__WEBPACK_IMPORTED_MODULE_0___default()(text);
...
/* harmony default export */ __webpack_exports__["default"] = (varToString);
...
/* harmony import */ var _functions_varToString__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../functions/varToString */ "./functions/varToString.tsx");
    ...
    for (var key in data) {
      if (key !== "_id" && key !== "name") {
        list.push(__jsx("li", {
          ...
          __self: this
        }, Object(_functions_varToString__WEBPACK_IMPORTED_MODULE_5__["default"])(key), ": ", data[key]));
      }
    }
...
//# sourceMappingURL=[id].js.0ff26817490049d4760c.hot-update.js.map