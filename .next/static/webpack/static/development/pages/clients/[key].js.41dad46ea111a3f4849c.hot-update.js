  ...
  var tableClients = clients.map(function (client) {
    ...
    var tableItem = function tableItem() {
      ...
      items.push(__jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_5__["default"], {
        ...
        href: "/clients/client/[id]/?key=".concat(user.user.userkey),
        as: "/clients/client/".concat(client._id, "/?key=").concat(user.user.userkey),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 74
        },
...
//# sourceMappingURL=[key].js.41dad46ea111a3f4849c.hot-update.js.map