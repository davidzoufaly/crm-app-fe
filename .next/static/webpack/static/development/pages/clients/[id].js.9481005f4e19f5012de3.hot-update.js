...
var Client = function Client(props) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, showAllProperities()), __jsx("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 39
    },
    __self: this
  }, new _functions_stringMethods__WEBPACK_IMPORTED_MODULE_5__["default"]("Tvoje stara smrdí jak piča").textToCamelString().replaceStringDiacritics().text));
};
...
//# sourceMappingURL=[id].js.9481005f4e19f5012de3.hot-update.js.map