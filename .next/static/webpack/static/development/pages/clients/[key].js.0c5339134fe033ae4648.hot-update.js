  ...
  var tableClients = clients.map(function (client) {
    ...
    var tableItem = function tableItem() {
      ...
      items.push(__jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_5__["default"], {
        ...
        href: "/clients?key=".concat(user.user.userkey, "&id=").concat(client._id),
        as: "/clients/".concat(user.user.userkey, "/clients/").concat(client._id),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 76
        },
...
//# sourceMappingURL=[key].js.0c5339134fe033ae4648.hot-update.js.map