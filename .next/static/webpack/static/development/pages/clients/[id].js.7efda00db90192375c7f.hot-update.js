...
var Client = function Client(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    document.title = "".concat(name, " ").concat(_library_globalVariables__WEBPACK_IMPORTED_MODULE_5__["default"].titleSubText);
    console.log(clientData);
    console.log(fieldsData);
  });

  var showAllProperities = function showAllProperities() {
    var list = []; // for (let key in clientData) {
...
//# sourceMappingURL=[id].js.7efda00db90192375c7f.hot-update.js.map