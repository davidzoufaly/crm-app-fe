...
var ClientForm = function ClientForm(_ref) {
  ...
  var inputs = fields.map(function (e) {
    if (e.fieldName !== _library_globalVariables__WEBPACK_IMPORTED_MODULE_1__["default"].permanentFields["Date added"] && e.fieldName !== _library_globalVariables__WEBPACK_IMPORTED_MODULE_1__["default"].permanentFields["Last modified"]) {
      if (e.fieldType === "text") {
        return __jsx("div", {
          key: e.fieldName,
          __source: {
...
//# sourceMappingURL=[key].js.dd1a67a20fe1ae20305a.hot-update.js.map