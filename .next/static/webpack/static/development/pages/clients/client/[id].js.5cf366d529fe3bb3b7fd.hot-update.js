          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return axios__WEBPACK_IMPORTED_MODULE_8___default()({
                method: "put",
                url: "".concat(_library_globalVariables__WEBPACK_IMPORTED_MODULE_16__["default"].serverURL, "/clients/").concat(router.query.id),
                params: {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_8___default()({
              method: "GET",
              url: "".concat(_library_globalVariables__WEBPACK_IMPORTED_MODULE_16__["default"].serverURL, "/clients/").concat(context.query.id),
              params: {
...
//# sourceMappingURL=[id].js.5cf366d529fe3bb3b7fd.hot-update.js.map