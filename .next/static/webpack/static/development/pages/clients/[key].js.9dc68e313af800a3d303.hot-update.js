    ...
    var tableItem = function tableItem() {
      for (var key in client) {
        ...
        if (client[key] !== client._id && fieldNames.includes(key)) {
          items[fieldNames.indexOf(key)] = __jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_5__["default"], {
      ...
      items.unshift(__jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_5__["default"], {
        padding: "checkbox",
        key: uniqid__WEBPACK_IMPORTED_MODULE_2___default()(),
        __source: {
          fileName: _jsxFileName,
      ...
      items.push(__jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_5__["default"], {
        key: uniqid__WEBPACK_IMPORTED_MODULE_2___default()(),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 73
        ...
        href: "/clients/client?key=".concat(user.user.userkey, "&id=").concat(client._id),
        as: "/clients/".concat(user.user.userkey, "/client/").concat(client._id),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 74
        },
      ...
      items = items.map(function (e) {
        return e === null ? __jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_5__["default"], {
          key: uniqid__WEBPACK_IMPORTED_MODULE_2___default()(),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 80
...
//# sourceMappingURL=[key].js.9dc68e313af800a3d303.hot-update.js.map