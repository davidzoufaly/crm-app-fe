...
var WebForm = function WebForm(_ref) {
    ...
    switch (action.type) {
      case "add":
        return state.map(function (field) {
          return field._id === action.payload.id ? Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, field, {
            fieldInForm: true
          }) : field;
        });
  ...
  var addedToForm = function addedToForm(e) {
    ...
    webFields.map(function (field) {
      return field._id === e.target.id ? field.fieldType !== "select" ? setWebFields({
        type: "add",
        payload: {
          id: e.target.id
        }
      }) : setOptionSelect(e.target.id) : null;
    });
  };
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx("h3", {
    ...
    webFields: webFields,
    addedToForm: addedToForm // optionSelect={optionSelect}
    ,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 64
...
//# sourceMappingURL=settings.js.9d91e802b13b2777401d.hot-update.js.map