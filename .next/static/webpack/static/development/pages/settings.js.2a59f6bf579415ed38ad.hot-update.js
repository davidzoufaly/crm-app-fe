...
var WebFormList = function WebFormList(_ref) {
  ...
  var list = webFields.map(function (_ref2) {
    ...
    return fieldInForm ? __jsx("li", {
      ...
      __self: this
    }, fieldName, fieldFormVisible && fieldType === "select" ? "-> visible in form" : fieldOptions.some(function (e) {
      return e.preselected;
    }) ? "->Hidden!" : // fieldOptions.filter(e => e.preselected)
    null, __jsx("button", {
      id: fieldName,
...
//# sourceMappingURL=settings.js.2a59f6bf579415ed38ad.hot-update.js.map