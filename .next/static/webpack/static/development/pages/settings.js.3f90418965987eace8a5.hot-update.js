...
var CustomClientFields = function CustomClientFields(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {// console.log(editedField.fieldOptions)
  });
      ...
      case "optionValueChange":
        return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state, {
          fieldOptions: state.fieldOptions.filter(function (el) {
            return action.payload.event.target.id === el.id ? el.value = action.payload.event.target.value : el;
          })
        });
...
//# sourceMappingURL=settings.js.3f90418965987eace8a5.hot-update.js.map