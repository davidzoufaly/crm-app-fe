...
var Dashboard = function Dashboard(_ref) {
  ...
  var campaignStr = lastCampaign ? "".concat(_library_languages__WEBPACK_IMPORTED_MODULE_12__["default"].en.last, " ").concat(_library_languages__WEBPACK_IMPORTED_MODULE_12__["default"].en.sent, " ").concat(lastCampaign[0].date, " ").concat(_library_languages__WEBPACK_IMPORTED_MODULE_12__["default"].en.to.toLowerCase(), " ").concat(lastCampaign[0].to.length, " ").concat(lastCampaign[0].to.length > 1 ? _library_languages__WEBPACK_IMPORTED_MODULE_12__["default"].en.clients : _library_languages__WEBPACK_IMPORTED_MODULE_12__["default"].en.client) : null;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_5___default()({
              method: "GET",
              // params: {user: context.query.user},
...
//# sourceMappingURL=dashboard.js.202ff334006a405ec913.hot-update.js.map