  ...
  var customFields = fields.filter(function (_ref2) {
    ...
    var optionsMap = function optionsMap() {
      return fieldOptions.map(function (e) {
        var optionFormatedText = new _library_stringMethods__WEBPACK_IMPORTED_MODULE_1__["default"](e).firstCharUpperCase().getString();
        var optionFormatedKex = new _library_stringMethods__WEBPACK_IMPORTED_MODULE_1__["default"](e).textToCamelString().replaceStringDiacritics().getString();
        return __jsx("li", {
          key: e,
          __source: {
...
//# sourceMappingURL=settings.js.fa91347894ed6922e37e.hot-update.js.map