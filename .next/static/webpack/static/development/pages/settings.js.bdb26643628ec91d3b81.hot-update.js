...
var webFormOptionSelect = function webFormOptionSelect(_ref) {
  ...
  var showPreselectOptions = function showPreselectOptions(e) {
    ...
    webFields.map(function (field) {
      return field.fieldName === e.target.id ? fieldOptionsArray.push(field.fieldOptions.forEach(function (option) {
        return __jsx("option", {
          key: option.id,
          value: option.value,
          __source: {
...
//# sourceMappingURL=settings.js.bdb26643628ec91d3b81.hot-update.js.map